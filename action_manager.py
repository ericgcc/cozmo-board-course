...
class ActionManager:
    ...
    def launch(self, custom_object):
        switcher={
            CustomObjectTypes.CustomType00: self.display_image,
            CustomObjectTypes.CustomType01: self.play_animation,
            CustomObjectTypes.CustomType02: self.trial_by_combat_performance,
            CustomObjectTypes.CustomType03: self.got_performance,
            CustomObjectTypes.CustomType04: self.unstack_cubes,
        }
    ...
    def trial_by_combat_performance(self):
